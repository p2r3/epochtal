...
const cvarTestSafe = {
  ...
  "sar_strafehud_x": (val) => true,
  "sar_strafehud_y": (val) => true,
  ...
  "sar_pp_hud_show_blue": (val, cheats) => !cheats,
  "sar_pp_hud_show_orange": (val, cheats) => !cheats,
  ...
  "sar_crosshair_mode": (val) => true,
  "sar_quickhud_mode": (val) => true,
  "sar_trace_draw_through_walls": (val, cheats) => !cheats,
  "sar_rhythmgame": (val, cheats) => !cheats,
  "cl_viewmodelfov": (val) => true
};
