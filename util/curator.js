...
module.exports = async function (args, context = epochtal) {
  ...
  switch (command) {
    ...
    case "v2": {
      ...
      const graphs = await Bun.file(`${__dirname}/../entgraphs.json`).json();
    ...
    case "graph": {
      ...
      for (const archiveName of archiveList) {
        ...
        let mapDensity;
        const densityCachePath = `${__dirname}/../pages/archive/${archiveName}/entdensity.json`;
      ...
      Bun.write(`${__dirname}/../entgraphs.json`, JSON.stringify(output));
      return output;
